...
import logoHorizontal from '../../assets/branding/TK_Logo horizontal dorado con sombreado.webp';
...
export function BrandMark({ className, compact = false, withIcon = true }: BrandMarkProps) {
  return (
    <div className={cn('flex items-center', withIcon ? 'gap-3.5' : 'gap-0', className)}>
      {withIcon ? (
        <div className="relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-[1.15rem] border border-white/10 bg-[rgba(225,226,225,0.9)] shadow-[0_16px_34px_rgba(0,0,0,0.16)]">
          <img
            alt=""
