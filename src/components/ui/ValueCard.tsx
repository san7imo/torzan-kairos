...
export function ValueCard({ className, description, index, title }: ValueCardProps) {
  return (
    <article
      className={cn(
        'group rounded-[2rem] border border-brand-blue/10 bg-white p-7 shadow-[0_18px_60px_rgba(33,33,33,0.08)] transition duration-300 hover:-translate-y-1 hover:border-accent-gold/45',
        className,
      )}
    >
